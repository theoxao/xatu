...
public interface JavaParserListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link JavaParser#awaitVariableInitializer}.
     *
     * @param ctx the parse tree
     */
    void enterAwaitVariableInitializer(JavaParser.AwaitVariableInitializerContext ctx);

    /**
     * Exit a parse tree produced by {@link JavaParser#awaitVariableInitializer}.
     *
     * @param ctx the parse tree
     */
    void exitAwaitVariableInitializer(JavaParser.AwaitVariableInitializerContext ctx);
