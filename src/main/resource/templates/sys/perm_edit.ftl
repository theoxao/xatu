...
<div class="row">
    <div class="col-lg-12">
        <form role="form">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    <label for="edit_modal_groupId" class="form-required">分组</label>
                    <select id="edit_modal_groupId" class="form-control" name="groupId">
                        <@c.options groupOptions record.groupId?c/>
                    </select>
                </div>
            </div>
            <div class="row">
